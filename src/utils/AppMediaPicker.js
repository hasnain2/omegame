    ...
    if (type === 'video') {
      ...
      if (AppConfig.IS_IOS_DEVICE) {
        callback({
          ...
          ext,
          type: 'video',
          oType: response?.mime ? response.mime : 'video/' + ext,
          uri: ORIGINAL_URI,
        });
      } else {
        callback({
      ...
      callback({
        image: {uri: ORIGINAL_URI},
        oType: response?.mime ? response.mime : 'image/' + ext,
        type,
        uri: ORIGINAL_URI,
      });
    }
    ...
    if (type === 'camera') {
      Alert.alert(
        ...
        [
          ...
          {
            text: 'PHOTO',
            onPress: () => OpenCameraPicker((dta) => callback(dta), 'photo'),
          },
          {
            text: 'VIDEO',
            onPress: () => OpenCameraPicker((dta) => callback(dta), 'video'),
          },
        ],
        {cancelable: false},
      );
      ...
      Alert.alert(
        ...
        [
          ...
          {
            text: 'PHOTO',
            onPress: () => OpenGalleryPicker((dta) => callback(dta), 'photo'),
          },
          {
            text: 'VIDEO',
            onPress: () => OpenGalleryPicker((dta) => callback(dta), 'video'),
          },
        ],
        {cancelable: false},
      );
