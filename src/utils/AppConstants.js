...
const FRIEND_STATUSES_ACTIONS = {
  // action on friends weather to
  BLOCKED: 'BLOCKED',
...
const SHARE_STATUS_TYPES = {
  // ----- providing share statuses types
  FACEBOOK: 'FACEBOOK',
  TWITTER: 'TWITTER',
};

const GET_FRIEND_LIST_TYPES = {
  // -----  get frieds/following/followers/blocked user list
  FRIEND: 'FRIEND',
  FOLLOWING: 'FOLLOWING',
  FOLLOWERS: 'FOLLOWERS',
  BLOCKED: 'BLOCKED',
