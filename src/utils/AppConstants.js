...
export { BUCKETS, COLORS, GENDERS_OF_USERS, COLOR_BUBBLE_SIZE, GET_ALL_USER_SORT_BY, DEEP_LINK_TYPES, ASSET_TYPES, PRIVACY, CHAT_SOCKET_EVENTS, FRIEND_STATUSES_ACTIONS, SHARE_STATUS_TYPES, GET_FRIEND_LIST_TYPES }