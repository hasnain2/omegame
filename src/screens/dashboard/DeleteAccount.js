  ...
  return (
    <View style={{flex: 1, backgroundColor: 'black'}}>
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        />
        <AppText color={AppTheme.colors.lightGrey} bold={true} size={1}>
      ...
      <View style={{padding: RFValue(20)}}>
        ...
        <AppText
          ...
          style={{paddingVertical: RFValue(10), lineHeight: RFValue(22)}}>
          - If you're sick of getting notifications you can{' '}
          <AppText
            onPress={() => {
              navigation.goBack();
            }}
        ...
        <AppText
          onPress={() => {
            navigation.navigate('EditUserProfileScreen', {data: user, userName: true});
          }}
          size={3}
          color={AppTheme.colors.lightGrey}
          style={{paddingVertical: RFValue(10), lineHeight: RFValue(22)}}>
          - If you want to change your username you can{' '}
          <AppText onPress={() => {}} size={3} color={AppTheme.colors.primary}>
            do that here
          </AppText>
          .
        </AppText>
        <AppText
          ...
          <AppText onPress={() => {}} size={3} bold={true} color={AppTheme.colors.lightGrey}>
            You will permanently lose your profile, messages and photos
          </AppText>
          .
        </AppText>
      </View>
