    ...
    <View style={{flex: 1, backgroundColor: 'black'}}>
      ...
      <KeyboardAvoidingScrollView>
        <View style={{paddingHorizontal: RFValue(16)}}>
          <AppText style={{fontSize: RFValue(24), fontWeight: 'bold'}}>Are you being impersonated?{'\n'}</AppText>
          <AppText size={3} style={{color: 'grey', lineHeight: RFValue(22)}}>
            {AppConfig.appName} takes safety seriously. If someone created an account pretending to be you, you can
