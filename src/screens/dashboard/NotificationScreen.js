  ...
  function getnotificationhistoryhelper(cursor) {
    GetNotificationHistory((notificatioHistoryResponse) => {
      if (notificatioHistoryResponse) {
        tempRequests = notificatioHistoryResponse.filter(
          (ii) => ii?.portion === 'upper',
        );
        let tempArr = [];
        ...
        let tempPlanNotifications = notificatioHistoryResponse.filter(
          (ii) => ii?.portion === 'lower',
        );
        ...
        dispatch(
          setNotifications({
            ...
            otherNotifications: RemoveDuplicateObjectsFromArray(
              tempPlanNotifications,
            ),
          }),
        );
  ...
  function acceptOrDenyRequest(userID, accept, index) {
    ...
    ActionsOnUsers(
      ...
      accept
        ...
        : FRIEND_STATUSES_ACTIONS.DENY_FOLLOW_REQUEST,
    );
                      ...
                      <View>
                        <View>
                          ...
                          <View
                            ...
                            {state.isFollowingArray.includes(
                              item?.createdBy?._id,
                            ) ? (
                              <AntDesign
                                name={'minus'}
                ...
                <TouchableOpacity
                  ...
                  <View
                    ...
                    <View style={{flex: 1, paddingHorizontal: RFValue(10)}}>
                      <AppText
                        color={item.read ? AppTheme.colors.lightGrey : 'white'}
                        size={2}>
                        {item.body}{' '}
