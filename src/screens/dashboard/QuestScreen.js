              ...
              <>
                      ...
                      <LinearGradient
                        ...
                        <View
                          ...
                          <View style={{flex: 1, justifyContent: 'center'}}>
                            ...
                            <AppText
                              size={1}
                              color={user?.nickNameColor ? user?.nickNameColor : AppTheme.colors.lightGrey}>
                ...
                <View style={{padding: RFValue(10), borderBottomWidth: 0.9, borderBottomColor: '#1A1A1A'}}>
                  <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <AppGoldCoin />
                      <AppText lines={2} color={'white'} size={1} bold={true} style={{paddingHorizontal: RFValue(10)}}>
                  ...
                  <View
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      ...
                      <AppText lines={2} color={'white'} size={1} style={{paddingHorizontal: RFValue(10)}} bold={true}>
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                    <AppText lines={2} color={AppTheme.colors.lightGrey} size={0} style={{paddingVertical: RFValue(5)}}>
