...
const OmegaStoreCornersTab = ({navigation, showBlur, toggleBlur}) => {
              ...
              <View
                ...
                <View style={{flex: 1, justifyContent: 'center', paddingVertical: RFValue(30), alignItems: 'center'}}>
                  <UserAvatar
                    ...
                    corner={item?.attachment?.url || false}
                ...
                <AppButtonPlane
                  onPress={() => {
                    if (!state.isModalVisible.isPurchased) {
                      Alert.alert(
                        'Buy',
                        `Purchase ${state.isModalVisible?.name} for ${state.isModalVisible?.priceInCoins}?`,
                        [
                          {
                            text: 'Cancel',
                            onPress: () => {
