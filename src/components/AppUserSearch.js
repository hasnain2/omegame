...
const AppUserSearch = ({show, toggle, selectedContacts, chosenContacts = [], showDone}) => {
      ...
      <View style={{flex: 1, width: '100%', backgroundColor: 'black', paddingVertical: RFValue(20)}}>
        ...
        <View style={{paddingHorizontal: RFValue(20)}}>
          <AppSearchBar
            hideFilter={true}
            onChangeText={(val) => {
              getfriendshelper(false, val ? val : '');
