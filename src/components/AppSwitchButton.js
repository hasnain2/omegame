...
const AppSwitchButton = ({value}) => {
  ...
  const SWITCH_SIZE_HEIGHT = RFValue(25);
  const SWITCH_SIZE_WIDTH = SWITCH_SIZE_HEIGHT + RFValue(25);
  return (
    <View
      style={{
        borderRadius: 90,
        backgroundColor: RAIL_COLOR,
        height: SWITCH_SIZE_HEIGHT,
        width: SWITCH_SIZE_WIDTH,
      ...
      <View
        ...
        <View
          style={{
            height: SWITCH_SIZE_HEIGHT - RFValue(10),
            width: SWITCH_SIZE_HEIGHT - RFValue(10),
