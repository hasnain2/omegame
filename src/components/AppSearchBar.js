...
const AppSearchBar = ({ onChangeText, onRightPess, hideFilter }) => {
    let [state, setState] = useState({
        searchTerm: ''
    })
    return (
        <View style={{ paddingVertical: RFValue(5), flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: AppTheme.colors.lightGrey, alignItems: 'center' }}>
